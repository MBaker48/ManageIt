	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="tax" class="col-sm-3 control-label">TAX 6%</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="tax" name="tax" disabled="true" />
				      <input type="hidden" class="form-control" id="taxValue" name="taxValue" />
				    </div>
				  </div> <!--/form-group-->			  
				  <div class="form-group">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
  			...
  			$sql = "SELECT orders.order_id, orders.order_date, orders.client_name, orders.client_contact, orders.sub_total, orders.tax, orders.total_amount, orders.discount, orders.grand_total, orders.paid, orders.due, orders.payment_type, orders.payment_status FROM orders 	
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="tax" class="col-sm-3 control-label">TAX 13%</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="tax" name="tax" disabled="true" value="<?php echo $data[5] ?>"  />
				      <input type="hidden" class="form-control" id="taxValue" name="taxValue" value="<?php echo $data[5] ?>"  />
				    </div>
				  </div> <!--/form-group-->			  
				  <div class="form-group">
				    <label for="totalAmount" class="col-sm-3 control-label">Total Amount</label>
